print("Welcome to UTM Code Generator\nThis tool will generate UTMs for you without an internet connection\nTo use this tool just fill in the fields. In case you want to skip a particular field, just press the 'Enter' key!")
